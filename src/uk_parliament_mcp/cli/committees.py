...
from uk_parliament_mcp.cli.pagination import COMMITTEES_PAGINATION
...
app = typer.Typer(help="Committee information, meetings, and evidence", no_args_is_help=True)
