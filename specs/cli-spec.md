...
**When** a developer or LLM wants to access UK Parliament data from the terminal
**I want to** run simple CLI commands with Unix-friendly output
**So that** I can query Parliament APIs without needing an MCP client, and pipe results to jq/grep/etc.
